Conjunto de dados que reúne informações sobre as renúncias e desonerações previstas na Lei Complementar Federal nº 101/01 (Lei de Responsabilidade Fiscal), disponibilizado em conformidade com a política estadual de transparência e de dados abertos.

Os dados são organizados em arquivos por tipo de renúncia e seguem um padrão estruturado, facilitando o uso por cidadãos, pesquisadores, órgãos de controle e desenvolvedores.
